...
def generate_mock_webapi_data_volumemesh():
    resp = RestApi(endpoint="volumemeshes/page", environment_provider=current_environment).get(
...
def generate_mock_webapi_data_one_volumemesh():
    ...
    resp = RestApi(endpoint=f"volumemeshes/{id}", environment_provider=current_environment).get()
    print(resp)
...
def generate_mock_webapi_data_one_case():
    ...
    resp = RestApi(endpoint=f"cases/{id}", environment_provider=current_environment).get()
    print(resp)
...
def generate_mock_webapi_data_one_case_params():
    id = "c58e7a75-e349-476a-9020-247af6b2e92b"
    resp = RestApi(
        endpoint=f"cases/{id}/runtimeParams", environment_provider=current_environment
    ).get()
    print(resp)
