...
class MockResponseDraftValidation(MockResponse):
    """response for POST /v2/drafts/{id}/validation"""

    @staticmethod
    def json():
        return {
            "data": {"fullSolverVersion": "release-24.11.0", "warnings": []},
            "code": "0",
            "error": None,
        }
...
MOCK_WORKSPACE_RECORDS = [
    {
        "id": "private-11111111-1111-1111-1111-111111111111",
        "name": "Home",
        "type": "PRIVATE",
        "status": "ENABLED",
        "rootFolderId": "ROOT.FLOW360",
    },
    {
        "id": "shared-22222222-2222-2222-2222-222222222222",
        "name": "Test Company",
        "type": "SHARED",
        "status": "ENABLED",
        "rootFolderId": "ROOT.FLOW360.SHAREDROOT",
    },
]


class MockResponseWorkspaces(MockResponse):
    """response for GET v2/workspaces"""

    @staticmethod
    def json():
        return {"data": MOCK_WORKSPACE_RECORDS}


GET_RESPONSE_MAP = {
    "/v2/workspaces": MockResponseWorkspaces,
...
def mock_webapi(type, url, params):
    ...
    if type == "get":
        ...
        if method.startswith("/v2/drafts/") and method.endswith("/validation"):
            return MockResponseDraftValidation()
