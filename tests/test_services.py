...
def test_validate_service():
    ...
    errors, warning = services.validate_flow360_params_model(params_as_dict=params_data, unit_system_context=fl.SI_unit_system)
...
def test_validate_service_missing_unit_system():
    ...
    with pytest.raises(ValueError):
        errors, warning = services.validate_flow360_params_model(params_as_dict=params_data, unit_system_context=None)
