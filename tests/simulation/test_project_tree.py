...
def _build_dict_tree(records):
    ...
    return build_project_tree(records, create_node=create_node, add_child=add_child)
...
def test_build_project_tree_rejects_invalid_records():
    ...
    with pytest.raises(ValueError, match="missing parent"):
        _build_dict_tree([{"id": "case-1", "parentId": "vm-1", "parentCaseId": None}])
