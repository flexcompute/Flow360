...
def test_updater_to_25_9_2_custom_volume_no_op_when_already_bounding_entities():
    """Test 25.9.2 updater is a no-op when CustomVolume already uses bounding_entities."""
    params_as_dict = {
        "version": "25.9.1",
        "meshing": {
            "volume_zones": [
...
def test_updater_total_pressure_no_double_conversion_across_branches():
    """Upgrading from 25.8.7 to 25.9.5 should only convert once, not twice."""
    params_as_dict = {
        "version": "25.8.7",
        "unit_system": {"name": "SI"},
        "operating_condition": {"type_name": "AerospaceCondition"},
