...
def test_validate_service():
    ...
    _, errors, _ = services.validate_model(params_as_dict=params_data, unit_system_name="SI", root_item_type='Geometry')
...
def test_validate_init_data_errors():
    ...
    _, errors, _ = services.validate_model(params_as_dict=data, unit_system_name="SI", root_item_type='Geometry')
    assert len(errors) == 3
    ...
    _, errors, _ = services.validate_model(params_as_dict=data, unit_system_name="SI", root_item_type='VolumeMesh')
    assert len(errors) == 1
