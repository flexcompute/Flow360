...
from flow360.component_v2 import units as u
from flow360.component_v2.unit_system import (
    AngularVelocityType,
    AreaType,
    CGS_unit_system,
    DensityType,
...
def test_unit_systems_compare():
    assert SI_unit_system != flow360_unit_system
    assert SI_unit_system != CGS_unit_system

    assert SI_unit_system == SI_unit_system
    assert flow360_unit_system == flow360_unit_system

    assert flow360_unit_system == u.UnitSystem(base_system="Flow360")
    assert SI_unit_system == u.UnitSystem(base_system="SI")
...
def test_unit_system_init():
    ...
    print(us)
    print(SI_unit_system)
    assert us == SI_unit_system
