...
def _validate_cht_no_heat_transfer(params):
    if params.outputs:
        for output in params.outputs:
            if isinstance(output, (SurfaceOutput, VolumeOutput, SliceOutput, ProbeOutput, IsosurfaceOutput)):
...
def _collect_used_boundary_names(params, param_info: ParamsValidationInfo, asset_boundaries: set[str]) -> set:
    ...
    for model in params.models:
        ...
        for entity in entities:
            # `PorousJump` surfaces are zone-to-zone interfaces in volume-mesh
