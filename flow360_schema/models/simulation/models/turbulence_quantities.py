...
class ModifiedTurbulentViscosityRatio(Flow360BaseModel):
    ...
    type_name: Literal["ModifiedTurbulentViscosityRatio"] = pd.Field("ModifiedTurbulentViscosityRatio", frozen=True)
...
class ModifiedTurbulentViscosity(Flow360BaseModel):
    ...
    type_name: Literal["ModifiedTurbulentViscosity"] = pd.Field("ModifiedTurbulentViscosity", frozen=True)
    modified_turbulent_viscosity: KinematicViscosity.PositiveFloat64 | None = pd.Field()


class SpecificDissipationRateAndTurbulentKineticEnergy(_SpecificDissipationRate, TurbulentKineticEnergy):
...
class TurbulentViscosityRatioAndTurbulentKineticEnergy(TurbulentViscosityRatio, TurbulentKineticEnergy):
...
class SpecificDissipationRateAndTurbulentViscosityRatio(_SpecificDissipationRate, TurbulentViscosityRatio):
...
class SpecificDissipationRateAndTurbulentLengthScale(_SpecificDissipationRate, TurbulentLengthScale):
...
def TurbulenceQuantities(
    ...
    if modified_viscosity_ratio is not None and non_none_arg_count == 1:
        return ModifiedTurbulentViscosityRatio(modified_turbulent_viscosity_ratio=modified_viscosity_ratio)
