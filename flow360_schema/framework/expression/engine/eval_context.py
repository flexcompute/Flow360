    ...
    def get(self, name: str, resolve: bool = True) -> Any:
        ...
        if name not in self._values:
            ...
            try:
                ...
                # Resolving may import a whitelisted module whose import side
                # effects register the canonical value for this name (e.g.
                # SolverVariable declarations registering their placeholder
                # values). Prefer that over the resolved module attribute.
                self._values.setdefault(name, val)
