"""Dependency graph for user variables."""
...
class DependencyGraph:
    ...
    def load_from_list(self, vars_list: list[dict[str, Any]]) -> None:
        ...
        try:
            ...
            for name in names:
                # ensure keys exist in defaultdict
                self._graph[name]  # noqa: B018
                self._deps[name]  # noqa: B018
    ...
    def update_expression(self, name: str, expression: str | None) -> None:
