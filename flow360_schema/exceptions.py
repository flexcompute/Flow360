...
class Flow360Error(Exception):
    ...
    #: Errors announce themselves as they are raised. Subclasses whose meaning depends
    #: on the catch site — a gateway timeout that may not be a failure at all — opt out
    #: and leave it to that site to decide what the user hears.
    logs_when_constructed = True
