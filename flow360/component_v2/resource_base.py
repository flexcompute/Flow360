...
class Flow360ResourceBaseModel(pd.BaseModel):
    ...
    created_at: Optional[str] = pd.Field(None, alias="createdAt")
    updated_at: Optional[datetime] = pd.Field(None, alias="updatedAt")
    updated_by: Optional[str] = pd.Field(None, alias="updatedBy")
    deleted: bool
    ...
    model_config = pd.ConfigDict(extra="allow", frozen=True)
