...
class Geometry(AssetBase):
    ...
    def _apply_dynamic_default_settings(self, simulation_dict: dict):
        """Populate this geometry's dynamic defaults from the asset's simulation dict.

        Part of asset initialization, not a user-facing accessor. Mutates
        ``default_settings["geometry_accuracy"]`` and ``_project_length_unit``.
        """
