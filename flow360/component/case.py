...
from ..cloud.utils import is_valid_uuid
...
class CaseDraft(CaseBase, ResourceDraft):
    ...
    def submit(self, force_submit: bool = False) -> Case:
        ...
        resp = RestApi(CaseInterface.endpoint, environment_provider=current_environment).post(
            json=data,
...
class Case(CaseBase, Flow360Resource):
    ...
    def move_to_folder(self, folder: Folder):
        ...
        """
        RestApi(FolderInterface.endpoint, environment_provider=current_environment).put(
    ...
    def rename(self, new_name: str):
        ...
        """
        RestApi(CaseInterfaceV2.endpoint, environment_provider=current_environment).patch(
