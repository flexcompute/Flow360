...
class CustomVolume(_VolumeEntityBase):
    """
    CustomVolume is a volume zone defined by its bounding entities.
    ...
    @pd.model_validator(mode="before")
    @classmethod
    def _rename_boundaries_to_bounding_entities(cls, value):
    ...
    @contextual_field_validator("bounding_entities", mode="after")
    @classmethod
    def _validate_bounding_entity_existence(cls, value, param_info: ParamsValidationInfo):
