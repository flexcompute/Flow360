...
class GhostSurface(_SurfaceEntityBase, metaclass=ABCMeta):
    """
    ...
    Since we already have sub-categories of `GhostSurface`, The `GhostSurface` itself will be a virtual class.
