...
from flow360.component.simulation.framework.base_model import Conflicts, Flow360BaseModel
...
class LinearSolver(Flow360BaseModel):
    ...
    max_iterations: Optional[PositiveInt] = pd.Field(50)
...
class GenericSolverSettings(Flow360BaseModel, metaclass=ABCMeta):
    ...
    linear_solver: Optional[LinearSolver] = pd.Field(LinearSolver())
...
class IncompressibleNavierStokesSolver(GenericSolverSettings):
