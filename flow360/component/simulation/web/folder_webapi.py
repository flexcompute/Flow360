...
class FolderWebApi:
    ...
    def __init__(self, folder_id: str):
        ...
        self._api = RestApi(
            FolderInterfaceV2.endpoint, id=folder_id, environment_provider=current_environment
        )
    ...
    def create(cls, name: str, tags=None, parent_folder_id: str = ROOT_FOLDER_ID):
        ...
        return RestApi(FolderInterface.endpoint, environment_provider=current_environment).post(
            json={
                "name": name,
                "tags": list(tags or []),
    ...
    def list_records(cls, include_subfolders: bool = True, page: int = 0, size: int = 1000):
        ...
        response = RestApi(
            FolderInterfaceV2.endpoint, environment_provider=current_environment
        ).get(
            params={
