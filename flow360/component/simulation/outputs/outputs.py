...
class SurfaceOutput(_AnimationAndFileFormatSettings):
    ...
    entities: EntityList[Surface, GhostSurface] = pd.Field(None, alias="surfaces")
...
class SliceOutput(_AnimationAndFileFormatSettings):
    ...
    name: Optional[str] = pd.Field(None)
    entities: EntityList[Slice] = pd.Field(None, alias="slices")
...
class IsosurfaceOutput(_AnimationAndFileFormatSettings):
    ...
    name: Optional[str] = pd.Field(None)
    entities: UniqueItemList[Isosurface] = pd.Field(None, alias="isosurfaces")
