...
data = {
    "type": "MyModel",
    "a_or_b": {"type": "MyModelA", "constructor": "from_b", "a": 2.0, "input_kwargs": {"b": 0}},
}
...
data = {
    "type": "MyModel",
    "a_or_b": {"type": "MyModelA", "constructor": "from_b", "a": None, "input_kwargs": {"b": 0}},
}
...
data = {
    ...
    "list_a_or_b": [
        {"type": "MyModelA", "constructor": "default", "a": 3.0, "input_kwargs": {}, "b": None},
        {"type": "MyModelB", "constructor": "from_b", "a": None, "input_kwargs": {"b": 4}, "b": 4},
    ],
}
data_parsed = parse_model_dict(data)
print(data_parsed)
