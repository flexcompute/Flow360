            ...
            for custom_volume in zone.entities.stored_entities:
                if isinstance(custom_volume, CustomVolume):
                    ...
                    for surface in custom_volume.boundaries.stored_entities:
                        if isinstance(surface, (GhostSurface, GhostSphere, GhostCircularPlane)):
                            # AutomatedFarfield ghost entities will be auto-generated by the mesher
                            # and should not appear in the patches list.
