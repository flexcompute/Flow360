...
def translate_imported_surface_output(
    output_params: list,
    imported_surface_output_class: Union[
        ImportedSurfaceOutput, TimeAverageImportedSurfaceOutput, ImportedSurfaceIntegralOutput
    ],
):
...
def process_user_variables_for_integral(
    ...
    suffix: str = "_integral",
    replace_node_normal: bool = False,
):
...
def translate_output(input_params: SimulationParams, translated: dict):
    ...
    if has_instance_in_list(outputs, ImportedSurfaceIntegralOutput):
        process_user_variables_for_integral(
            outputs,
            ImportedSurfaceIntegralOutput,
            suffix="_imported_integral",
            replace_node_normal=True,
        )
        translated["importedSurfaceIntegralOutput"] = translate_imported_surface_output(
            outputs, ImportedSurfaceIntegralOutput
        )
