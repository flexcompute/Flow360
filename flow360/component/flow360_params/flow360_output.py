...
class LegacyOutputFormat(pd.BaseModel, metaclass=ABCMeta):
    ...
    linear_residual_navier_stokes: Optional[bool] = pd.Field(alias="linearResidualNavierStokes")
    residual_transition: Optional[bool] = pd.Field(alias="residualTransition")
    linear_residual_transition: Optional[bool] = pd.Field(alias="linearResidualTransition")
    residual_turbulence: Optional[bool] = pd.Field(alias="residualTurbulence")
    linear_residual_turbulence: Optional[bool] = pd.Field(alias="linearResidualTurbulence")
