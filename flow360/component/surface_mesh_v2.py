...
class SurfaceMeshDraftV2(ResourceDraft):
    ...
    def _create_project_root_resource(self, description: str = "") -> SurfaceMeshMetaV2:
        ...
        resp = RestApi(
            SurfaceMeshInterfaceV2.endpoint, environment_provider=current_environment
        ).post(req.dict())
    ...
    def _create_dependency_resource(
        ...
        resp = RestApi(
            SurfaceMeshInterfaceV2.endpoint, environment_provider=current_environment
        ).post(req.dict(), method="dependency")
        return SurfaceMeshMetaV2(**resp)
...
class SurfaceMeshV2(AssetBase):
    ...
    def _apply_dynamic_default_settings(self, simulation_dict: dict):
        """Populate the default surface mesh settings from the simulation dict"""
