...
def _build_deduplicated_entity_registry_from_params(params: SimulationParams) -> EntityRegistry:
    ...
    models/outputs). This function deduplicates by (entity_type, private_attribute_id),
    keeping the first occurrence which represents the user's latest modifications.
    """
