"""Generic simulation JSON compaction for CLI inspection."""
...
def summarize_simulation(simulation_json: dict) -> dict:
    """Validate simulation JSON and return a compact JSON projection."""

    display_dict, normalized_dict, default_dict = _load_summary_dicts(simulation_json)
...
def _load_summary_dicts(simulation_json: dict) -> tuple[dict, dict, dict | None]:
