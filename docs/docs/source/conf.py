...
def _flow360_source_paths() -> list[str]:
    ...
    )  # <root>/flex/public/Flow360 (contains flow360/)
...
html_theme_options = {
    ...
    "max_navbar_depth": 6,
    # pydata-sphinx-theme >=0.17 force-defaults navbar_persistent to a header
    # search field when the project doesn't set it, bypassing sphinx-book-theme's
    # theme.conf override and yielding a second search box next to the book
    # theme's sidebar search. Keep the header slot explicitly empty.
    "navbar_persistent": [],
}
