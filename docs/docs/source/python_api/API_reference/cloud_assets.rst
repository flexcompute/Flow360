...
For comprehensive information on project structure, asset types, and workflows, see the :ref:`Project Management <project_management>` section in the User Guide. A project is created inside a :ref:`workspace <workspaces>`.
