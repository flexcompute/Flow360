...
| [Case comparison](./06.case-comparison.md) | Side-by-side comparison of multiple cases: configuration diff, shared visualization, and charts with CSV export | Cross-case and parameter-sweep analysis |
...
*Place several cases side by side to study trends across a sweep or compare design variants.*

**Features:**
- Add and compare multiple cases against a chosen reference
- Inline diff of each case's simulation configuration against the reference
- Side-by-side flow-field visualization (up to four cases) with synchronized cameras
- XY and series (convergence, min/max, forces and moments) plots
- Chart, table, or combined layouts
