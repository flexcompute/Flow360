    ...
    params = fl.SimulationParams(
        meshing=fl.MeshingParams(
            ...
            refinements=[
                ...
                fl.SurfaceEdgeRefinement(
                    ...
                    edges=[draft.edges["trailingEdge"]],
                ),
                fl.SurfaceRefinement(max_edge_length=0.5, faces=[draft.surfaces["wing*"]]),
        ...
        models=[
            ...
            fl.Wall(
                surfaces=[
                    draft.surfaces["*Left"],
                    draft.surfaces["*Right"],
                    draft.surfaces["fuselage"],
                ],
            ),
        ...
        user_defined_dynamics=[
            fl.UserDefinedDynamic(
                ...
                input_boundary_patches=[draft.surfaces["aileronRight"]],
            ),
            fl.UserDefinedDynamic(
                ...
                input_boundary_patches=[draft.surfaces["aileronLeft"]],
            ),
            fl.UserDefinedDynamic(
                ...
                input_boundary_patches=[draft.surfaces["rudderRight"]],
            ),
            fl.UserDefinedDynamic(
                ...
                input_boundary_patches=[draft.surfaces["rudderLeft"]],
            ),
        ],
    )
